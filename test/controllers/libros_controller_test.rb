...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { año_publicación: @libro.año_publicación, editorial: @libro.editorial, nombre: @libro.nombre, portada: @libro.portada } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { año_publicación: @libro.año_publicación, editorial: @libro.editorial, nombre: @libro.nombre, portada: @libro.portada } }
